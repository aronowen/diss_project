...
d3.csv("../js/Student_F/prev_data.csv", function(error, dataset)
{
    if (error)
    {
        throw error;
...
{
    d3.csv("../js/Student_F/data.csv", function(error, dataset)
    {
        if (error)
        {
            throw error;
        ...
        if(overall > 40 && overall <= 60)
        {
            ...
            document.getElementById("face_Emoji").classList.add("fa-meh");
            ...
            document.getElementById("face").style.color="#FFB347";
